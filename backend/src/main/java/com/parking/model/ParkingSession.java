...
public class ParkingSession {
    ...
    public enum SessionStatus {
        ACTIVE, COMPLETED, PASSED_CONFIRMED, LOST_CARD
    }
    ...
    public UUID getValidatedQrId() {
        return validatedQrId;
    }

    public void setValidatedQrId(UUID validatedQrId) {
        this.validatedQrId = validatedQrId;
    }
    ...
    public void setAssignedZoneId(UUID assignedZoneId) {
        this.assignedZoneId = assignedZoneId;
    }

    public UUID getParkedSlotId() {
        return parkedSlotId;
    }

    public void setParkedSlotId(UUID parkedSlotId) {
        this.parkedSlotId = parkedSlotId;
    }
    ...
    public UUID getOverrideByStaff() {
        return overrideByStaff;
    }

    public void setOverrideByStaff(UUID overrideByStaff) {
    ...
    public UUID getMobileCheckoutStaffId() {
        return mobileCheckoutStaffId;
    }

    public void setMobileCheckoutStaffId(UUID mobileCheckoutStaffId) {
    ...
    public Instant getMobileCheckoutAt() {
        return mobileCheckoutAt;
    }

    public void setMobileCheckoutAt(Instant mobileCheckoutAt) {
        this.mobileCheckoutAt = mobileCheckoutAt;
    }

    public String getMobileCheckoutPhoto() {
        return mobileCheckoutPhoto;
    }

    public void setMobileCheckoutPhoto(String mobileCheckoutPhoto) {
        this.mobileCheckoutPhoto = mobileCheckoutPhoto;
    }

    public String getLostCardProofPhotos() {
        return lostCardProofPhotos;
    }

    public void setLostCardProofPhotos(String lostCardProofPhotos) {
        this.lostCardProofPhotos = lostCardProofPhotos;
    }
