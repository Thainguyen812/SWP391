...
| FR-028 | External System (ETC Reader) | ETC reader integration | The system shall accept ETC reader payloads (etc_tag_code) and verify them against registered vehicle etc_tag_code for VIP flows. |
