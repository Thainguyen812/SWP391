        ...
        {filteredVehicles.map((v: any) => (
          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 border-t border-b border-slate-100 py-3.5 text-left leading-normal font-sans">
                <div>
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">LOẠI XE</span>
                  <strong className="text-xs font-black text-slate-700 block mt-0.5 truncate">{v.type}</strong>
                </div>
                <div>
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">ĐỘNG CƠ</span>
                  <strong className="text-xs font-black text-slate-700 block mt-0.5">
                    {v.fuelType === 'ELECTRIC' ? '⚡ Xe Điện' : '⛽ Xe Xăng'}
                  </strong>
                </div>
                <div>
                  {v.activeSubscription ? (
                    <>
                      ...
                      <strong className="text-xs font-black text-emerald-600 block mt-0.5 truncate">
