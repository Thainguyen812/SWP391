...
export const TopAppBarSection = () => {
  ...
  const { searchValue, setSearchValue, currentUser, useMockData, setUseMockData } = useGlobalContext();
    ...
    <header className="top-app-bar bg-white px-6 h-16 flex items-center justify-between shadow-sm border-b border-slate-200">
      ...
      <div className="flex items-center justify-end gap-4 flex-1">
        <button 
          ...
          title={useMockData ? "Đang dùng dữ liệu giả lập (Mock). Bấm để chuyển sang dữ liệu thật." : "Đang dùng dữ liệu thật từ Backend. Bấm để chuyển sang dữ liệu giả lập."}
        >
